...
<template>
  <button
    :class="twMerge(
      'inline-flex break-keep items-center cursor-pointer text-sm gap-1 px-4 py-1.5 bg-dark-100 text-dark-800 rounded-md hover:bg-dark-200 transition border border-transparent',
